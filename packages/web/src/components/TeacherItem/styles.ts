  ...
  footer {
    ...
    a {
      ...
      &:hover {
        ...
        background: ${props =>
          darken(0.02, props.theme.colors.themeColors.secondary)};
      }
    }
    ...
    a.toWatch {
      ...
      color: ${props => props.theme.colors.themeColors.primary.normal};
      border: 1px solid
        ${props => props.theme.colors.themeColors.primary.normal};
...
export const SchedulesItem = styled.li<SchedulesItemProps>`
  ...
  color: ${({ theme, active }) =>
    active
      ? theme.colors.themeColors.text.dark
      : theme.colors.themeColors.text.normal};
  border: 1px solid
    ${({ theme }) => darken(0.1, theme.colors.themeColors.tertiary)};
  border-radius: 6px;
